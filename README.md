...
[![Build Status](https://travis-ci.org/xgfone/ramsql.svg)](https://travis-ci.org/xgfone/ramsql)
...
```
  go get github.com/xgfone/ramsql
```
...
```console
$ go install github.com/xgfone/ramsql
$ ramsql < schema.sql
